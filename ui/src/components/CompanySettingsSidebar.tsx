...
import { ChevronLeft, CloudUpload, Github, KeyRound, Layers, MailPlus, MonitorCog, Puzzle, Settings, SlidersHorizontal, Users } from "lucide-react";
    ...
    <aside className="w-full h-full min-h-0 border-r border-border bg-background flex flex-col">
      ...
      <nav className="flex-1 min-h-0 overflow-y-auto scrollbar-auto-hide px-3 py-2">
        <div className="flex flex-col gap-0.5">
          ...
          <SidebarNavItem to="/company/settings/github-credential" label="GitHub Access" icon={Github} end />
        </div>
      </nav>
    </aside>
  );
